...
!function(a, b) {
    ...
    n.extend({
        ...
        proxy: function(a, b) {
            ...
            ,
            f.ObjectId = a.ObjectId = a.ObjectId || n.ObjectId++,
            f) : void 0
        },
        now: Date.now,
        support: k
    ...
    n.event = {
        ...
        add: function(a, b, c, d, e) {
            ...
            if (r) {
                ...
                c = f.handler,
                e = f.selector),
                c.ObjectId || (c.ObjectId = n.ObjectId++),
                ...
                while (j--)
                    ...
                    k.handler.ObjectId || (k.handler.ObjectId = c.ObjectId)),
            ...
            if (r && (i = r.events)) {
                ...
                while (j--)
                    ...
                    o) {
                        ...
                        while (f--)
                            k = m[f],
                            !e && q !== k.origType || c && c.ObjectId !== k.ObjectId || h && !h.test(k.namespace) || d && d !== k.selector && ("**" !== d || !k.selector) || (m.splice(f, 1),
    ...
    n.fn.extend({
        on: function(a, b, c, d, e) {
            ...
            ,
            d.ObjectId = f.ObjectId || (f.ObjectId = n.ObjectId++)),
            this.each(function() {
